...
urlpatterns = [
    ...
    path('add-dailyprice/', add_dailypricing, name='add_dailypricing'),
    ...
    path('dailypricing-panel/', dailypricing_panel, name='dailypricing_panel'),
    ...
    path('delete-dailypricing/<int:pk>/', delete_dailypricing, name='delete_dailypricing'),
    ...
    path('update-dailypricing/<int:pk>/', update_dailypricing, name='update_dailypricing'),
